...
// Logged-out / browsing-only identity.
...
export const MOCK_USERS: User[] = [
  ...
  },
  {
    id: "citizen-3",
    name: "Zainab Bello",
    email: "zainab@trisonet.com",
    role: "citizen_seller",
    avatar: "/avatars/zainab.jpg",
    location: "Kano, Nigeria",
    bio: "Leatherwork, beadwork, and traditional jewellery from Northern Nigeria.",
    tagline: "Heritage craft, made to last",
    joinedAt: "2024-03-18",
  },
  {
    id: "buyer-1",
...
export const MOCK_PRODUCTS: Product[] = [
  ...
  },
  {
    ...
    description: "Compact waterproof Bluetooth speaker with 12-hour playback and deep bass. Great for outdoor use.",
    price: 70,
    quantity: 18,
    category: "Audio",
    status: "live",
  ...
  {
    id: "prod-10",
    name: "Smartwatch Series 6 (Unlocked)",
    description: "Feature-packed smartwatch with heart-rate monitoring, GPS, and always-on display. Cross-platform.",
    price: 180,
    quantity: 9,
    category: "Smartphones",
    status: "live",
  ...
  },
  {
    ...
    description: "Full-grain leather tote, hand-stitched with brass hardware. Ages beautifully with use.",
    price: 120,
    quantity: 14,
    category: "Fashion",
    status: "live",
  ...
  },
  {
    ...
    description: "Hand-strung glass-bead necklace inspired by Northern Nigerian patterns. One-of-a-kind piece.",
    price: 38,
    quantity: 22,
    category: "Fashion",
    status: "live",
  ...
  },
  {
    ...
    description: "High-capacity power bank with fast charging and dual USB-C output. Charges a phone up to 4 times.",
    price: 55,
    quantity: 40,
    department: "Electronics",
    category: "Audio",
    ...
    qcComment: "Verified authentic. Approved.",
    negotiable: false,
    location: "Lagos, Nigeria",
    views: 118,
  },
  {
    id: "prod-14",
    name: "Men's Agbada 3-Piece Set",
    description: "Premium embroidered Agbada set in rich fabric. Tailored fit, available in multiple colours.",
    price: 210,
    quantity: 16,
    department: "Fashion",
    category: "Dresses",
...
export const MOCK_TRANSACTIONS: Transaction[] = [
  ...
  },
  {
    ...
    amount: 45,
    status: "completed",
    confirmationNumber: "TRN-2024-002",
  ...
  },
  {
    ...
    amount: 64,
    status: "processing",
    confirmationNumber: "TRN-2024-003",
